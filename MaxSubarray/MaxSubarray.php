...
class MaxSubarray implements MaxSubarrayInterface
{
     ...
     * The idea is to start at all indexes in the arrays and calculate sum of subarray starting from the index to the last index of
     * the input array.
     * Time complexity is O(n^2) because it uses two loops.
     *
     * @param array $array
     *
     * @return int
